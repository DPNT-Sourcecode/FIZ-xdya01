...
module.exports = function (number) {
    ...
    if(number % 3 === 0 && nr_3 > 0 && (nr_5 > 0 || number % 5 === 0)) deluxe = 1;
    if(number % 5 === 0 && nr_5 > 0 && (nr_3 > 0 || number % 3 === 0)) deluxe = 1;
    ...
    else if ((nr_5 > 0 || number % 5 === 0) && (nr_3 > 0 || number % 3 === 0) && deluxe === 0) return "fizz buzz";
    else if ((nr_3 > 0 || number % 3 === 0) && deluxe === 0) return "fizz";
    else if ((nr_5 > 0 || number % 5 === 0) && deluxe === 0) return "buzz";
    else return number;
