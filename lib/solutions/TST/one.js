...
let nr_5 = 0;
let nr_3 = 0;
let deluxe = 0; //presupunem ca numarul are deja toate cifrele identice, iar in While verificam acest lucru; Daca variabile isi modifica valoarea in 0, atunci numarul nu este "deluxe";
...
if (number % 3 === 0 && nr_3 > 0 && nr_5 === 0 && number % 5) deluxe = 1;
if (number % 5 === 0 && nr_5 > 0 && nr_3 === 0 && number % 3) deluxe = 1;

if (deluxe === 1 && number % 15 === 0) {
    if (number % 2) return "fizz buzz fake deluxe";
    else return "fizz buzz deluxe";
}
if (deluxe === 1 && nr_3 > 0 && number % 3 === 0) {
    if (number % 2) return "fizz fake deluxe";
    else return "fizz deluxe";
}
else if (deluxe === 1 && nr_5 > 0 && number % 5 === 0) {
    if (number % 2) return "buzz fake deluxe";
    else return "buzz deluxe";
}
else if ((nr_5 > 0 || number % 5 === 0) && (nr_3 > 0 || number % 3 === 0)) return "fizz buzz";
